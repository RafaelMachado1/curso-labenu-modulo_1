...
}else if(nacionalidade === 'Colobiana'){
    console.log('nacionalidade Colombiana')
...
if(nacionalidade1 === 'brasileira' || nacionalidade1 === 'argentina' || nacionalidade1 === 'uruguaia' || nacionalidade1 === 'chilena' || nacionalidade1 === 'colombiana'){
